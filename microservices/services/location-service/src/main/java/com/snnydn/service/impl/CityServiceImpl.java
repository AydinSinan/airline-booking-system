...
import com.snnydn.mapper.CityMapper;
import com.snnydn.model.City;
import com.snnydn.payload.request.CityRequest;
import com.snnydn.payload.response.CityResponse;
import com.snnydn.repository.CityRepository;
import com.snnydn.service.CityService;
...
public class CityServiceImpl implements CityService {
    ...
    public CityResponse updateCity(Long id, CityRequest request) throws Exception {
        City city = cityRepository.findById(id).orElseThrow(
                () -> new Exception("City not exist with given code")
        );
    ...
    @Override
    public Page<CityResponse> getCitiesByCountyCode(String countryCode, Pageable pageable) {
